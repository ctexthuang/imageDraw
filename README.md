...
- 图像模型：来自设置页保存的图片模型列表。
- 图片数量：`1` 到 `5` 张，默认 `1` 张。
- 尺寸：`auto`、`1024x1024`、`1536x1024`、`1024x1536`、`2048x2048`、`2048x1152`、`3840x2160`、`2160x3840`。

部分供应商可能不支持所有尺寸。如果接口返回错误，请降低分辨率，或换一个模型重试。
...
本项目基于 GPL-3.0 开源协议发布，详见 [LICENSE](./LICENSE)。
